...
[![CI](https://github.com/YOUR_USERNAME/ai-tg-bot/actions/workflows/ci.yml/badge.svg)](https://github.com/YOUR_USERNAME/ai-tg-bot/actions/workflows/ci.yml)
...
- ✅ Линтинг (Ruff)
- ✅ Проверка типов (Mypy)
- ✅ Тесты с coverage (Pytest, минимум 70%)
